...
$net = \CV\DNN\readNetFromONNX(__DIR__ . '/models/centerface.onnx');

$src = \CV\imread(__DIR__ . '/path/to/file');
...
\CV\imwrite(__DIR__ . "/output/_detect_facemarks_by_dnn_centerface.jpg", $src);